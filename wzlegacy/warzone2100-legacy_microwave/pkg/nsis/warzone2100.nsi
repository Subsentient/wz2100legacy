...
VIAddVersionKey "CompanyName"		"Warzone 2100 Legacy Development Team"
VIAddVersionKey "FileDescription"	"${PACKAGE_NAME} Installer"
VIAddVersionKey "FileVersion"		"${PACKAGE_VERSION}"
VIAddVersionKey "InternalName"		"${PACKAGE_NAME}"
VIAddVersionKey "LegalCopyright"	"Copyright © 2012 Subsentient"
...
;Interface Settings
  ...
  !define MUI_WELCOMEPAGE_TITLE "Welcome to Warzone 2100 Legacy . ${PACKAGE_VERSION}"
...
Section $(TEXT_SecBase) SecBase
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PACKAGE_NAME}-${PACKAGE_VERSION}" "Publisher" "Warzone 2100 Legacy"
