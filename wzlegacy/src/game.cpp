	...
	if (saveGame.sGame.type == CAMPAIGN)
	{
		...
		for (int i=1; i < MAX_PLAYERS; i++)
		{
			if (saveGame.sGame.skDiff[i] == UBYTE_MAX)
			{
				...
				//removed wz2100.net and added legacy devs. -Subsentient
				debug(LOG_ERROR, "Savegame corruption detected, trying to salvage.  Please Report this issue to the Warzone 2100 Legacy developers.");
