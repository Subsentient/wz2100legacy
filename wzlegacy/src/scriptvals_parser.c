...
/* In a future release of Bison, this section will be replaced
   by #include "scriptvals_parser.h".  */
...
{
       0,   142,   142,   143,   147,   146,   167,   166,   182,   223,
     224,   225,   228,   717,   726,   730,   743,   747,   760,   765,
     770
};
#endif
...
static const char *const yytname[] =
{
  ...
  "array_index_list", "var_entry", "var_value", YY_NULL
};
#endif
...
#line 229 "scriptvals_parser.y"
    {
					...
					case ST_RESEARCH:
						...
						data.v.oval = getResearch((yyvsp[(3) - (3)].sInit).pString, true);	/* store pointer */
						if (data.v.oval == NULL)
						{
