...
static bool startTitleMenu(void)
{
	...
	//No, no thank you. addSmallTextButton(FRONTEND_HYPERLINK, FRONTEND_POS8X, FRONTEND_POS8Y, _("Warzone 2100 is completely free and open source (FLOSS). Official site: http://wz2100.net/"), 0);
...
bool runVideoOptionsMenu(void)
{
	...
	switch (id)
	{
		...
		{	//Make shader switching actually work -Subsentient
